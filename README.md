...
> **Deployment Link:** (https://group3-capstone-project-three.vercel.app/)
...
1. **Clone the repository**
   \`bash
   git clone https://github.com/opeyemiamusa/group3-capstone-project
   \`
...
4. **Start the local development server**
   ...
   npm run dev
   \`\`\`
    If you are using Create React App instead of Vite, use `npm start` instead.
